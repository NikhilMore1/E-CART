...
<Link to={`/Notification1`}><img src={product.image} className="card-img-top" alt={product.Heading} height="300"/></Link>
...
<Link to={`/Notification1`}><img src={book.image} className="card-img-top" alt={book.Heading} height="300"/></Link>
<div className="card-body">
...
<div className="row" style={{border:'1px solid wheat',color:'gray',borderRadius:'10px'}}>
            ...
            {mobiles.map((mobile) => (
                    <div key={mobile._id}>
                         <div className="row">
                   <div className="card" style={{width:'320px',height:'540px'}}>
<Link to={`/Notification1`}><img src={mobile.image} className="card-img-top" alt={mobile.Heading} height="300"/></Link>
<div className="card-body">
