...
function ElecDetails() {
    ...
    const fetchDatahis = async () => {
        ...
        const fetchData = async () => {
            try {
                const resp = await axios.get(`http://localhost:5000/api/elec/${_id}`);
                    ...
                    <div className="row">
                        ...
                        <div className="col-5" style={{ marginLeft: '1rem' }}>
                               ...
                               <div className="row">
                                ...
                                <div className="col">
                                <h4 style={{color:'black',fontWeight:'bold',textDecoration:'line-through'}}>₹{product.discount}</h4>
                                </div>
                               </div>
                                </div>
                            <p>Operating System <b>{product.os}</b></p>
                            <p> Display: <b>{product.display}</b></p>
