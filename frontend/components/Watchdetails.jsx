...
function Watchdetails() {
    const [product, setProduct] = useState({}); // Initialize as empty object
    const { _id } = useParams(); // Use `_id` from URL parameters
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const resp = await axios.get(`http://localhost:5000/api/Watch/${_id}`);
                            ...
                            <div className="col-lg-8 col-md-6">
                                ...
                                <div className="row">
                                    <div className="col-3 col-md-2">
                                        <div className="card-text" style={{ border: '1px solid green', backgroundColor: 'green', borderRadius: '10px', textAlign: 'center', height: '30px', color: 'white', fontWeight: 'bold',width:'100px' }}>{product.Rating}⭐</div>
                                    </div>
