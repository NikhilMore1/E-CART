...
function BookDetails() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const resp = await axios.get(`http://localhost:5000/api/books/${_id}`);
                            ...
                            <div className="col-7" style={{ marginLeft: '1rem' }}>
                                ...
                                <div className="row mt-3">
                                    ...
                                    <div className="col" style={{lineHeight:'0.6'}}>
                                        <p className="mt-1" style={{ color: 'gray',fontSize:'20px',textDecoration:'line-through' }}><b>{product.discount}</b></p>
